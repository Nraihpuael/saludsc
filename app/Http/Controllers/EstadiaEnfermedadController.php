...
class EstadiaEnfermedadController extends Controller
{
    ...
    {
        $casos = estadia_enfermedad::paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        */ 
        ...
        $estadia->user_id = $request->user_id;
        $estadia->estado_id = $request->estado_id;
        $estadia->enfermedad_id = $request->enfermedad_id;
        $estadia->estadia_id = $request->estadia_id;
        $estadia->detalle = $request->detalle;
        $estadia->save(); 
    ...
    public function show(estadia_enfermedad $registrarcasosPunto)
    {
        ...
        $puntoAtencion = estadia_enfermedad::find($registrarcasosPunto->id);
