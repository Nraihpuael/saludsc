...
Route::middleware([
    ...
    Route::get('arima/', [ArimaController::class, 'index'])->name('arima.index');
    ...
    //Imports
    Route::post('/importLab', [ImportController::class, 'importLab'])->name('import.importLab');
    Route::post('/importPuntoAtencion', [ImportController::class, 'importPuntoAtencion'])->name('import.puntoAtencion');
    Route::post('/importCasos', [ImportController::class, 'importCasos'])->name('import.casos');
