            ...
            <div
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <select id="red_id" name="red"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="CENTRO" {{ $puntosatencion->red == 'CENTRO' ? 'selected' : '' }}>Centro</option>
                            <option value="SUR" {{ $puntosatencion->red == 'SUR' ? 'selected' : '' }}>Sur</option>
                            <option value="NORTE" {{ $puntosatencion->red == 'NORTE' ? 'selected' : '' }}>Norte</option>
                            <option value="ESTE" {{ $puntosatencion->red == 'ESTE' ? 'selected' : '' }}>Este</option>
                        </select>
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <select id="distrito_id" name="distrito"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @for($i = 1; $i <= 15; $i++)
                                <option value="{{ $i }}" {{ $puntosatencion->distrito == $i ? 'selected' : '' }}>{{ $i }}</option>
                            @endfor
                        </select>
                    </div>
