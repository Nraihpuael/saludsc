...
class CreateEstadiaEnfermedadsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('estadia_enfermedads', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('estadia_id');
            $table->foreign('estadia_id')->references('id')->on('punto_atencions')->onUpdate('cascade')
            ->onDelete('cascade')->nullable();

            $table->unsignedBigInteger('estadia_enfermedable_id')->nullable();
